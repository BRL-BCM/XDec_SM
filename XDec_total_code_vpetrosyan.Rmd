...
set.seed(12345)
stability.TCGA.SC.Model = estimate_stability(TCGA.Beta.GEO.Refs, chosenProbes.GEO.7.PAM50, k.cells, subset_prop = 0.8, num_subsets = 3, reps_per_subset = 3, max_its = 2000, rss_diff_stop = 1e-10)
...
set.seed(12345)
stability.TCGA.SC.Model = estimate_stability(TCGA.Beta.Trans, chosenProbes.SC.PAM50, k.cells, subset_prop = 0.8, num_subsets = 3, reps_per_subset = 3, max_its = 2000, rss_diff_stop = 1e-10)
